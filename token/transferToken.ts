...
(async () => {
  ...
  console.log("tokenAccountXPubkey",tokenAccountXPubkey.toBase58())
  console.log("tokenAccountYPubkey",tokenAccountYPubkey.toBase58())
  ...
  // 1) use build-in function
  {
    let txhash = await transferChecked(
      ...
      alice, // from's owner
      1e1, // amount, if your deciamls is 8, send 10^8 for 1 token
      1 // decimals
    );
